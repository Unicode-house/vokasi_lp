...
function GalleryPage () {
  ...
  return (
    <div className='relative min-h-screen py-4 flex mt-12 bg-[#fdfaf6] flex-col items-center gap-12'>
      <div className='flex flex-col items-center text-center space-y-2'>
        <h1 className='text-4xl md:text-5xl font-light tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-gray-800 via-gray-600 to-gray-400'>
      ...
      {/* Tombol Lihat Semua */}
      <a href='/gallery' className='mb-6 px-6 py-3 bg-gray-800 text-white rounded-full shadow-md hover:bg-gray-700 transition'>
        Lihat Semua
      </a>
    </div>
  )
